...
public interface PhongTroRepository extends JpaRepository<PhongTro, Long>, JpaSpecificationExecutor<PhongTro> {
    ...
    long countByTrangThai(PhongTro.TrangThai trangThai);
    long countByLoaiPhongIgnoreCase(String loaiPhong);
    long countByLoaiPhongIgnoreCaseAndTrangThai(String loaiPhong, PhongTro.TrangThai trangThai);
